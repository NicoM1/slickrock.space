...
Main.prototype = {
	_windowLoaded: function() {
		...
		this.postHttp.onError = function(error2) {
			haxe_Log.trace(error2,{ fileName : "Main.hx", lineNumber : 128, className : "Main", methodName : "_windowLoaded"});
			_g.requestInProgress = false;
		};
		...
		if(this.lastY < 500) {
			if(this.firstIndex > 0) {
				...
				histHttp.onError = function(e) {
					...
					haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 271, className : "Main", methodName : "_tryGetOldMessages"});
				};
	...
	,_checkValid: function(printValid) {
		...
		checkValid.onError = function(e) {
			...
			haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 333, className : "Main", methodName : "_checkValid"});
	...
	,_getID: function(_) {
		...
		idHttp.onError = function(e) {
			haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 565, className : "Main", methodName : "_getID"});
	...
	,_claimRoom: function($arguments) {
		...
		lockHttp.onError = function(e) {
			haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 617, className : "Main", methodName : "_claimRoom"});
	...
	,_reclaimRoom: function($arguments) {
		...
		lockHttp.onError = function(e) {
			haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 641, className : "Main", methodName : "_reclaimRoom"});
	...
	,_authorizeRoom: function($arguments) {
		...
		lockHttp.onError = function(e) {
			haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 666, className : "Main", methodName : "_authorizeRoom"});
	...
	,_lockRoom: function($arguments) {
		...
		lockHttp.onError = function(e) {
			haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 721, className : "Main", methodName : "_lockRoom"});
	...
	,_unlockRoom: function(_) {
		...
		lockHttp.onError = function(e) {
			haxe_Log.trace(e,{ fileName : "Main.hx", lineNumber : 739, className : "Main", methodName : "_unlockRoom"});
	...
	,_checkKeyPress: function(e) {
		...
		if(this.chatbox.value.charAt(0) == "/") {
			...
			if(this.selectedElem != null) {
				...
				haxe_Log.trace(command,{ fileName : "Main.hx", lineNumber : 1100, className : "Main", methodName : "_checkKeyPress"});
				...
				if(this.chatbox.value.indexOf(command) == -1) {
					if(this.chatbox.value.charAt(this.chatbox.value.length - 1) == " " || code != null && (code == 13 || code == 9)) {
						haxe_Log.trace(this.chatbox.value,{ fileName : "Main.hx", lineNumber : 1104, className : "Main", methodName : "_checkKeyPress", customParams : [replacement]});
