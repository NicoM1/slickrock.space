...
Main.prototype = {
	_windowLoaded: function() {
		...
		if(!this.ios) {
			...
			this._loop();
		} else this._addMessage(null,null,"iframes are unreliable in iOS, please view this chat directly on <a href=\"slickrock.io/" + this.room + "\">slickrock.io/" + this.room + "</a>");
	}
