...
var Main = function() {
	...
	(function(instance,parent) {
		...
		var processor1 = new abe_core_ArgumentProcessor(filters1,[]);
		var process1 = new RouteHandler_$top_$RouteProcess({ },instance,processor1);
		var uses1 = [];
		router.registerMethod("/top","get",process1,uses1,[]);
		var filters2 = new abe_core_ArgumentsFilter();
		var processor2 = new abe_core_ArgumentProcessor(filters2,[{ name : "room", optional : false, type : "String", sources : ["params"]}]);
		var process2 = new RouteHandler_$chatroom_$RouteProcess({ room : null},instance,processor2);
		var uses2 = [];
		router.registerMethod("/:room","get",process2,uses2,[]);
		var filters3 = new abe_core_ArgumentsFilter();
		var processor3 = new abe_core_ArgumentProcessor(filters3,[{ name : "message", optional : false, type : "String", sources : ["params"]},{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "id", optional : false, type : "String", sources : ["params"]},{ name : "privateID", optional : false, type : "String", sources : ["params"]},{ name : "token", optional : false, type : "String", sources : ["params"]}]);
		var process3 = new RouteHandler_$sendMessage_$RouteProcess({ message : null, room : null, id : null, privateID : null, token : null},instance,processor3);
		var uses3 = [];
		router.registerMethod("/chat/:message/:room/:id/:privateID/:token","post",process3,uses3,[]);
		var filters4 = new abe_core_ArgumentsFilter();
		var processor4 = new abe_core_ArgumentProcessor(filters4,[{ name : "message", optional : false, type : "String", sources : ["params"]},{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "password", optional : false, type : "String", sources : ["params"]},{ name : "id", optional : false, type : "String", sources : ["params"]},{ name : "privateID", optional : false, type : "String", sources : ["params"]},{ name : "token", optional : false, type : "String", sources : ["params"]}]);
		var process4 = new RouteHandler_$sendMessageWithPass_$RouteProcess({ message : null, room : null, password : null, id : null, privateID : null, token : null},instance,processor4);
		var uses4 = [];
		router.registerMethod("/chat/:message/:room/:password/:id/:privateID/:token","post",process4,uses4,[]);
		var filters5 = new abe_core_ArgumentsFilter();
		var processor5 = new abe_core_ArgumentProcessor(filters5,[]);
		var process5 = new RouteHandler_$getID_$RouteProcess({ },instance,processor5);
		var uses5 = [];
		router.registerMethod("/api/getID","post",process5,uses5,[]);
		var filters6 = new abe_core_ArgumentsFilter();
		var processor6 = new abe_core_ArgumentProcessor(filters6,[]);
		var process6 = new RouteHandler_$makeRandomRoom_$RouteProcess({ },instance,processor6);
		var uses6 = [];
		router.registerMethod("/api/makeRandomRoom","get",process6,uses6,[]);
		var filters7 = new abe_core_ArgumentsFilter();
		var processor7 = new abe_core_ArgumentProcessor(filters7,[]);
		var process7 = new RouteHandler_$getTopRooms_$RouteProcess({ },instance,processor7);
		var uses7 = [];
		router.registerMethod("/api/getTopRooms","get",process7,uses7,[]);
		var filters8 = new abe_core_ArgumentsFilter();
		var processor8 = new abe_core_ArgumentProcessor(filters8,[]);
		var process8 = new RouteHandler_$getRandomRoom_$RouteProcess({ },instance,processor8);
		var uses8 = [];
		router.registerMethod("/api/getRandomRoom","get",process8,uses8,[]);
		var filters9 = new abe_core_ArgumentsFilter();
		var processor9 = new abe_core_ArgumentProcessor(filters9,[{ name : "privateID", optional : false, type : "String", sources : ["params"]}]);
		var process9 = new RouteHandler_$getToken_$RouteProcess({ privateID : null},instance,processor9);
		var uses9 = [];
		router.registerMethod("/api/gettoken/:privateID","post",process9,uses9,[]);
		var filters10 = new abe_core_ArgumentsFilter();
		var processor10 = new abe_core_ArgumentProcessor(filters10,[{ name : "privateID", optional : false, type : "String", sources : ["params"]},{ name : "token", optional : false, type : "String", sources : ["params"]}]);
		var process10 = new RouteHandler_$checkValid_$RouteProcess({ privateID : null, token : null},instance,processor10);
		var uses10 = [];
		router.registerMethod("/api/checkvalid/:privateID/:token","post",process10,uses10,[]);
		var filters11 = new abe_core_ArgumentsFilter();
		var processor11 = new abe_core_ArgumentProcessor(filters11,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "id", optional : false, type : "String", sources : ["params"]}]);
		var process11 = new RouteHandler_$typing_$RouteProcess({ room : null, id : null},instance,processor11);
		var uses11 = [];
		router.registerMethod("/api/typing/:room/:id","get",process11,uses11,[]);
		var filters12 = new abe_core_ArgumentsFilter();
		var processor12 = new abe_core_ArgumentProcessor(filters12,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "id", optional : false, type : "String", sources : ["params"]}]);
		var process12 = new RouteHandler_$typing_$RouteProcess({ room : null, id : null},instance,processor12);
		var uses12 = [];
		router.registerMethod("/api/typing/:room/:id","post",process12,uses12,[]);
		var filters13 = new abe_core_ArgumentsFilter();
		var processor13 = new abe_core_ArgumentProcessor(filters13,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "privateID", optional : false, type : "String", sources : ["params"]},{ name : "password", optional : false, type : "String", sources : ["params"]},{ name : "privatePass", optional : false, type : "String", sources : ["params"]}]);
		var process13 = new RouteHandler_$lockRoom_$RouteProcess({ room : null, privateID : null, password : null, privatePass : null},instance,processor13);
		var uses13 = [];
		router.registerMethod("/api/lock/:room/:privateID/:password/:privatePass","post",process13,uses13,[]);
		var filters14 = new abe_core_ArgumentsFilter();
		var processor14 = new abe_core_ArgumentProcessor(filters14,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "privatePass", optional : false, type : "String", sources : ["params"]}]);
		var process14 = new RouteHandler_$emptyRoom_$RouteProcess({ room : null, privatePass : null},instance,processor14);
		var uses14 = [];
		router.registerMethod("/api/empty/:room/:privatePass","post",process14,uses14,[]);
		var filters15 = new abe_core_ArgumentsFilter();
		var processor15 = new abe_core_ArgumentProcessor(filters15,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "privatePass", optional : false, type : "String", sources : ["params"]},{ name : "id", optional : false, type : "String", sources : ["params"]}]);
		var process15 = new RouteHandler_$deleteMessage_$RouteProcess({ room : null, privatePass : null, id : null},instance,processor15);
		var uses15 = [];
		router.registerMethod("/api/deleteMessage/:room/:privatePass/:id","post",process15,uses15,[]);
		var filters16 = new abe_core_ArgumentsFilter();
		var processor16 = new abe_core_ArgumentProcessor(filters16,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "privateID", optional : false, type : "String", sources : ["params"]},{ name : "privatePass", optional : false, type : "String", sources : ["params"]}]);
		var process16 = new RouteHandler_$unlockRoom_$RouteProcess({ room : null, privateID : null, privatePass : null},instance,processor16);
		var uses16 = [];
		router.registerMethod("/api/unlock/:room/:privateID/:privatePass","post",process16,uses16,[]);
		var filters17 = new abe_core_ArgumentsFilter();
		var processor17 = new abe_core_ArgumentProcessor(filters17,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "privateID", optional : false, type : "String", sources : ["params"]},{ name : "privatePass", optional : false, type : "String", sources : ["params"]}]);
		var process17 = new RouteHandler_$claimRoom_$RouteProcess({ room : null, privateID : null, privatePass : null},instance,processor17);
		var uses17 = [];
		router.registerMethod("/api/claim/:room/:privateID/:privatePass","post",process17,uses17,[]);
		var filters18 = new abe_core_ArgumentsFilter();
		var processor18 = new abe_core_ArgumentProcessor(filters18,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "privateID", optional : false, type : "String", sources : ["params"]},{ name : "oldAdmin", optional : false, type : "String", sources : ["params"]},{ name : "newAdmin", optional : false, type : "String", sources : ["params"]}]);
		var process18 = new RouteHandler_$reclaimRoom_$RouteProcess({ room : null, privateID : null, oldAdmin : null, newAdmin : null},instance,processor18);
		var uses18 = [];
		router.registerMethod("/api/claim/:room/:privateID/:oldAdmin/:newAdmin","post",process18,uses18,[]);
		var filters19 = new abe_core_ArgumentsFilter();
		var processor19 = new abe_core_ArgumentProcessor(filters19,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "lastID", optional : false, type : "Int", sources : ["params"]}]);
		var process19 = new RouteHandler_$getMessages_$RouteProcess({ room : null, lastID : null},instance,processor19);
		var uses19 = [];
		router.registerMethod("/api/:room/:lastID","post",process19,uses19,[]);
		var filters20 = new abe_core_ArgumentsFilter();
		var processor20 = new abe_core_ArgumentProcessor(filters20,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "password", optional : false, type : "String", sources : ["params"]},{ name : "lastID", optional : false, type : "Int", sources : ["params"]}]);
		var process20 = new RouteHandler_$getMessagesWithPass_$RouteProcess({ room : null, password : null, lastID : null},instance,processor20);
		var uses20 = [];
		router.registerMethod("/api/:room/:password/:lastID","post",process20,uses20,[]);
		var filters21 = new abe_core_ArgumentsFilter();
		var processor21 = new abe_core_ArgumentProcessor(filters21,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "lastID", optional : false, type : "Int", sources : ["params"]},{ name : "firstID", optional : false, type : "Int", sources : ["params"]}]);
		var process21 = new RouteHandler_$getMessagesHist_$RouteProcess({ room : null, lastID : null, firstID : null},instance,processor21);
		var uses21 = [];
		router.registerMethod("/api/hist/:room/:lastID/:firstID","get",process21,uses21,[]);
		...
		var uses22 = [];
		router.registerMethod("/api/hist/:room/:lastID/:firstID","post",process22,uses22,[]);
		var filters23 = new abe_core_ArgumentsFilter();
		var processor23 = new abe_core_ArgumentProcessor(filters23,[{ name : "room", optional : false, type : "String", sources : ["params"]},{ name : "password", optional : false, type : "String", sources : ["params"]},{ name : "lastID", optional : false, type : "Int", sources : ["params"]},{ name : "firstID", optional : false, type : "Int", sources : ["params"]}]);
		var process23 = new RouteHandler_$getMessagesHistWithPass_$RouteProcess({ room : null, password : null, lastID : null, firstID : null},instance,processor23);
		var uses23 = [];
		router.registerMethod("/api/hist/:room/:password/:lastID/:firstID","post",process23,uses23,[]);
		return router;
...
RouteHandler.prototype = {
	...
	,chatroom: function(room,request,response,next) {
		...
		this._serveHtml("bin/index.html",function(e,d) {
			if(e == null) {
				...
				var theme;
				if(Main.rooms.get(room).theme != null) theme = Main.rooms.get(room).theme; else theme = "dark";
	...
	,_sendMessage: function(response,message,room,password,id,privateID,token) {
		...
		if(Main.tokens.get(privateID) == token) {
			...
			if(roomE.lock == null || roomE.lock == haxe_crypto_Sha1.encode(roomE.salt + password)) {
				...
				var index = -1;
				var _g1 = 0;
				var _g = Main.userCounts.get(room).length;
				while(_g1 < _g) {
					var i = _g1++;
	...
	,getTopRooms: function(request,response,next) {
		...
		while( $it0.hasNext() ) {
			...
			while(_g < count.length) {
				var u = count[_g];
				++_g;
				if(new Date().getTime() - u.timestamp.getTime() > this.oneWeek) toRemove.push(u);
			}
			var _g1 = 0;
			while(_g1 < toRemove.length) {
				var u1 = toRemove[_g1];
				++_g1;
	...
	,emptyRoom: function(room,privatePass,request,response,next) {
		room = room.toLowerCase();
		var roomE = Main.rooms.get(room);
	...
	,reclaimRoom: function(room,privateID,oldAdmin,newAdmin,request,response,next) {
		room = room.toLowerCase();
		var roomE = Main.rooms.get(room);
	...
	,getMessagesHist: function(room,lastID,firstID,request,response,next) {
		room = room.toLowerCase();
		this._getMessages(response,room,null,lastID,firstID);
	}
	,getMessagesHistWithPass: function(room,password,lastID,firstID,request,response,next) {
		room = room.toLowerCase();
		this._getMessages(response,room,password,lastID,firstID);
	}
	,_getMessages: function(response,room,password,lastID,firstID) {
		if(!Main.hasMongo()) {
			response.setHeader("Access-Control-Allow-Origin","*");
		...
		if(roomE.lock == null || roomE.lock == haxe_crypto_Sha1.encode(roomE.salt + password)) {
			...
			if(firstID != null) {
				...
				if(start > 0) start = start; else start = 0;
...
var RouteHandler_$deleteMessage_$RouteProcess = function(args,instance,argumentProcessor) {
	abe_core_RouteProcess.call(this,args,instance,argumentProcessor);
};
RouteHandler_$deleteMessage_$RouteProcess.__name__ = ["RouteHandler_deleteMessage_RouteProcess"];
RouteHandler_$deleteMessage_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$deleteMessage_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.deleteMessage(this.args.room,this.args.privatePass,this.args.id,request,response,next);
	}
	,__class__: RouteHandler_$deleteMessage_$RouteProcess
});
var RouteHandler_$emptyRoom_$RouteProcess = function(args,instance,argumentProcessor) {
	abe_core_RouteProcess.call(this,args,instance,argumentProcessor);
};
RouteHandler_$emptyRoom_$RouteProcess.__name__ = ["RouteHandler_emptyRoom_RouteProcess"];
RouteHandler_$emptyRoom_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$emptyRoom_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.emptyRoom(this.args.room,this.args.privatePass,request,response,next);
	}
	,__class__: RouteHandler_$emptyRoom_$RouteProcess
});
...
var RouteHandler_$getMessagesHistWithPass_$RouteProcess = function(args,instance,argumentProcessor) {
	abe_core_RouteProcess.call(this,args,instance,argumentProcessor);
};
RouteHandler_$getMessagesHistWithPass_$RouteProcess.__name__ = ["RouteHandler_getMessagesHistWithPass_RouteProcess"];
RouteHandler_$getMessagesHistWithPass_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$getMessagesHistWithPass_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.getMessagesHistWithPass(this.args.room,this.args.password,this.args.lastID,this.args.firstID,request,response,next);
	}
	,__class__: RouteHandler_$getMessagesHistWithPass_$RouteProcess
});
var RouteHandler_$getMessagesHist_$RouteProcess = function(args,instance,argumentProcessor) {
	abe_core_RouteProcess.call(this,args,instance,argumentProcessor);
};
RouteHandler_$getMessagesHist_$RouteProcess.__name__ = ["RouteHandler_getMessagesHist_RouteProcess"];
RouteHandler_$getMessagesHist_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$getMessagesHist_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.getMessagesHist(this.args.room,this.args.lastID,this.args.firstID,request,response,next);
	}
	,__class__: RouteHandler_$getMessagesHist_$RouteProcess
});
...
var RouteHandler_$getRandomRoom_$RouteProcess = function(args,instance,argumentProcessor) {
	abe_core_RouteProcess.call(this,args,instance,argumentProcessor);
};
RouteHandler_$getRandomRoom_$RouteProcess.__name__ = ["RouteHandler_getRandomRoom_RouteProcess"];
RouteHandler_$getRandomRoom_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$getRandomRoom_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.getRandomRoom(request,response,next);
	}
	,__class__: RouteHandler_$getRandomRoom_$RouteProcess
});
...
var RouteHandler_$getTopRooms_$RouteProcess = function(args,instance,argumentProcessor) {
	abe_core_RouteProcess.call(this,args,instance,argumentProcessor);
};
RouteHandler_$getTopRooms_$RouteProcess.__name__ = ["RouteHandler_getTopRooms_RouteProcess"];
RouteHandler_$getTopRooms_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$getTopRooms_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.getTopRooms(request,response,next);
	}
	,__class__: RouteHandler_$getTopRooms_$RouteProcess
});
...
var RouteHandler_$makeRandomRoom_$RouteProcess = function(args,instance,argumentProcessor) {
	abe_core_RouteProcess.call(this,args,instance,argumentProcessor);
};
RouteHandler_$makeRandomRoom_$RouteProcess.__name__ = ["RouteHandler_makeRandomRoom_RouteProcess"];
RouteHandler_$makeRandomRoom_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$makeRandomRoom_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.makeRandomRoom(request,response,next);
	}
	,__class__: RouteHandler_$makeRandomRoom_$RouteProcess
});
var RouteHandler_$reclaimRoom_$RouteProcess = function(args,instance,argumentProcessor) {
	abe_core_RouteProcess.call(this,args,instance,argumentProcessor);
};
RouteHandler_$reclaimRoom_$RouteProcess.__name__ = ["RouteHandler_reclaimRoom_RouteProcess"];
RouteHandler_$reclaimRoom_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$reclaimRoom_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.reclaimRoom(this.args.room,this.args.privateID,this.args.oldAdmin,this.args.newAdmin,request,response,next);
	}
	,__class__: RouteHandler_$reclaimRoom_$RouteProcess
});
...
RouteHandler_$top_$RouteProcess.__name__ = ["RouteHandler_top_RouteProcess"];
RouteHandler_$top_$RouteProcess.__super__ = abe_core_RouteProcess;
RouteHandler_$top_$RouteProcess.prototype = $extend(abe_core_RouteProcess.prototype,{
	execute: function(request,response,next) {
		this.instance.top(request,response,next);
	}
	,__class__: RouteHandler_$top_$RouteProcess
});
